...
def test_post_file():
    ...
    assert curlified == (
        'curl -X POST -H \'Content-Length: 557\' -H \'Content-Type: multipart/form-data; boundary='
        + boundary
        + '\' -d \'--'
        + boundary
        + '\r\\nContent-Disposition: form-data; name="file"; filename="data.csv"\r\\n\r\\n"Id";"Title";"Content"\\n1;"Simple Test";"Ici un test d\'"\'"\'échappement de simple quote"\\n2;"UTF-8 Test";"ăѣ𝔠ծềſģȟᎥ𝒋ǩľḿꞑȯ𝘱𝑞𝗋𝘴ȶ𝞄𝜈ψ𝒙𝘆𝚣1234567890!@#$%^&*()-_=+[{]};:\'"\'"\'",<.>/?~𝘈Ḇ𝖢𝕯٤ḞԍНǏ𝙅ƘԸⲘ𝙉০Ρ𝗤Ɍ𝓢ȚЦ𝒱Ѡ𝓧ƳȤѧᖯć𝗱ễ𝑓𝙜Ⴙ𝞲𝑗𝒌ļṃŉо𝞎𝒒ᵲꜱ𝙩ừ𝗏ŵ𝒙𝒚ź1234567890!@#$%^&*()-_=+[{]};:\'"\'"\'",<.>/?"\r\\n--'
        + boundary
